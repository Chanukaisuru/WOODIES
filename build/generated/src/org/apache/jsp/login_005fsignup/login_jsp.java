...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    <form method=\"POST\" action=\"login_back.jsp\" class=\"flex flex-col h-full justify-center items-center text-center\">\n");
      ...
      out.write("\n");
      out.write("                        <h6 style='color:red'>Incorrect username or password</h6>\n");
      out.write("                        ");
      ...
      out.write("\n");
      out.write("                        <br>\n");
      out.write("                        <input type=\"email\" placeholder=\"Email\" name=\"email\" class=\"bg-gray-100 border-none py-3 px-4 mb-3 w-full rounded-3xl focus:outline-none focus:ring-2 focus:ring-yellow-500\" />\n");
      out.write("                        <div class=\"relative w-full\">\n");
      out.write("                            <input type=\"password\" placeholder=\"Password\" name=\"password\" class=\"bg-gray-100 border-none py-3 px-4 mb-4 w-full rounded-3xl focus:outline-none focus:ring-2 focus:ring-yellow-500\" id=\"signinPassword\"/>\n");
      out.write("                            <i  id=\"signinTogglePassword\"></i>\n");
      out.write("                        </div>\n");
      out.write("                        \n");
      out.write("                        <a href=\"#\" class=\"text-gray-700 text-sm no-underline mb-5\">Forgot your password?</a>\n");
      out.write("                        \n");
      out.write("                        <button type=\"submit\" class=\"rounded-full border border-yellow-500 bg-yellow-500 text-white text-base font-bold py-3 px-11 uppercase tracking-wide transition hover:bg-yellow-600 mb-5\">Sign In</button>\n");
      out.write("                       \n");
      out.write("                    </form>\n");
      out.write("                </div>\n");
      out.write("            </div>\n");
